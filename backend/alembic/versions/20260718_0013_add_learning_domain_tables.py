...
def upgrade() -> None:
    ...
    if not inspector.has_table("learning_profiles"):
        op.create_table(
            "learning_profiles",
    ...
    if not inspector.has_table("learning_weaknesses"):
        op.create_table(
            "learning_weaknesses",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column("user_id", sa.Integer(), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    if not inspector.has_table("learning_practices"):
        op.create_table(
            "learning_practices",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column("user_id", sa.Integer(), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False, index=True),
    ...
    if not inspector.has_table("learning_assessments"):
        op.create_table(
    ...
    if not inspector.has_table("learning_review_items"):
        op.create_table(
