...
RagConversation 记录对话元数据（标题、知识库、压缩摘要），
RagMessage 记录每条用户/助手消息及引用和记忆提取状态。
"""
...
class RagMessage(Base):
    ...
    memory_json = Column(Text, nullable=True, comment="DEPRECATED: RAG memory system removed; no longer populated.")
    memory_extracted = Column(Boolean, nullable=False, default=False, comment="DEPRECATED: RAG memory system removed; no longer populated.")
