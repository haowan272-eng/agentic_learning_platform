...
def run_document_index(
    ...
    try:
        ...
        from app.services.document_quality import assess_document_chunks, save_quality_report

        quality_report = assess_document_chunks(db, document)
        save_quality_report(db, document, quality_report)
        db.commit()
